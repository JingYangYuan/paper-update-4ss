...
| # | Agent Name | 文件路径 | 职责 | 工具 |
|---|-----------|---------|------|------|
| 38 | `paper-update-purpose-routing-consultant` | `agents/purpose-routing-consultant.md` | 区分学科知识、写作范式、方法协议、流程协议、工具模板、self-update 或 mixed | Read, Grep |
| 39 | `paper-update-knowledge-extraction-consultant` | `agents/knowledge-extraction-consultant.md` | 从材料中抽取理论、写作范式、方法协议、流程协议和工具模板候选项 | Read, Grep |
| 40 | `paper-update-literature-enrichment-consultant` | `agents/literature-enrichment-consultant.md` | 为学科知识、方法协议和文献策略类候选补充证据、争议状态和适用边界 | Read, Grep, WebSearch, WebFetch |
| 41 | `paper-update-target-routing-consultant` | `agents/target-routing-consultant.md` | 读取 target registry 和模块 targets 文件，路由到目标模块、目标面、目标文件和建议位置 | Read, Grep |
| 42 | `paper-update-review-gate-consultant` | `agents/review-gate-consultant.md` | 复核来源、证据、风险等级、self-update、验证方式、跨模块影响和 pending 状态 | Read, Grep |
